...
deleteRouter.delete('/deletecustomer', controllDelete.deleteCustomer);
...
deleteRouter.delete('/deleteservicecustomer/:identificacion/:id_servicio_cliente', controllDelete.deleteServiceCustomer);
